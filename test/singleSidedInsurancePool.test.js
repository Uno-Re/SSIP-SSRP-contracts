...
//         console.log('[lpPrice check =======>]', expectedLpPrice.toString(), lpPriceAfter.toString())
...
//       //   await this.singleSidedInsurancePool
//       //     .connect(this.signers[3])
//       //     .policyClaim(this.signers[5].address, getBigNumber('30000'), 0, true, { from: this.signers[3].address })
...
//           expect(unobalanceInMigrate).to.equal(getBigNumber('9999.99999999999'))
//         })
