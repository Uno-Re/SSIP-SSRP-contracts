...
contract PoolUSDMTest is Test {
    ...
    function setUp() public {
        ...
        // Set staking start time to current block timestamp
    ...
    function testWithdrawAfterRebase() public {
        ...
        // Fund rewarder
        vm.startPrank(multiSigWallet);
        usdmToken.mint(multiSigWallet, depositAmount * 2);
        usdmToken.approve(address(pool.rewarder()), depositAmount);
        usdmToken.transfer(address(pool.rewarder()), depositAmount);
        vm.stopPrank();
