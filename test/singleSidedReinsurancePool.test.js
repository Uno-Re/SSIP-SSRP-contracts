...
//     //   await this.singleSidedReinsurancePool.addProtocol(
//     //     "Protocol1",
//     //     "Product1",
//     //     "PremiumDescription1",
//     //     BigNumber.from(24 * 3600).mul(365),
...
//     //     this.salesPolicyFactory.address,
//     //   )
//     //   expect(await this.singleSidedReinsurancePool.allProtocolsLength()).equal(1)
//     // })
...
//     // })
//     // it("Should initialize rewarder", async function () {
//     //   await this.singleSidedReinsurancePool.createRiskPool(
//     //     "UNO-LP",
//     //     "UNO-LP",
//     //     this.riskPoolFactory.address,
...
//     //   await this.mockUNO.transfer(this.rewarder.address, getBigNumber(100000))
//     //   const poolInfo = await this.singleSidedReinsurancePool.poolInfo()
//     //   const rewarderBalance = await this.mockUNO.balanceOf(this.rewarder.address)
//     //   expect(rewarderBalance).equal(getBigNumber(100000))
//     //   expect(poolInfo.unoMultiplierPerBlock).equal(getBigNumber(1))
//     // })
//     // it("Should update premium pool address", async function () {
//     //   const premiumPoolAddressBefore = await this.singleSidedReinsurancePool.premiumPool()
//     //   await this.singleSidedReinsurancePool.setPremiumPool(this.signers[3].address)
//     //   const premiumPoolAddressAfter = await this.singleSidedReinsurancePool.premiumPool()
...
//       //   expect(poolBalance, getBigNumber(10000))
...
//       //   const riskPool = this.RiskPool.attach(this.poolAddress)
//       //   const riskPoolBalanceBefore = await riskPool.balanceOf(this.signers[0].address)
//       //   const unoBalanceBefore = await this.mockUNO.balanceOf(this.signers[0].address)
//       //   expect(riskPoolBalanceBefore).to.equal(getBigNumber(10000))
//       //   // signer 0 submit WR for the 1000 UNO
//       //   await this.singleSidedReinsurancePool.leaveFromPoolInPending(getBigNumber(10000))
//       //   // check the uno and risk pool LP token balance of the singer 0 after withdraw
//       //   const riskPoolBalanceAfter = await riskPool.balanceOf(this.signers[0].address)
//       //   const unoBalanceAfter = await this.mockUNO.balanceOf(this.signers[0].address)
//       //   expect(riskPoolBalanceAfter).to.equal(getBigNumber(10000))
...
//       //   console.log(pendingWithdrawRequest1["pendingAmount"].toString())
//       //   expect(pendingWithdrawRequest1["pendingAmount"]).to.equal(getBigNumber(1000))
//       //   expect(pendingWithdrawRequest2["pendingAmount"]).to.equal(getBigNumber(1000))
...
//       //   const unoBalanceBefore = await this.mockUNO.balanceOf(this.signers[0].address)
//       //   expect(riskPoolBalanceBefore).to.equal(getBigNumber(10000))
//       //   const pendingUnoReward = await this.singleSidedReinsurancePool.pendingUno(this.signers[0].address)
//       //   // signer 0 submit WR for the 1000 UNO
//       //   await this.singleSidedReinsurancePool.leaveFromPoolInPending(getBigNumber(1000))
//       //   const currentDate = new Date()
...
//       //   const expectedUnoBalance = unoBalanceBefore.add(pendingUnoReward).add(getBigNumber(1000)).add(getBigNumber(15, 17))
//       //   expect(riskPoolBalanceAfter).to.equal(getBigNumber(9000))
//       //   expect(expectedUnoBalance).to.equal(unoBalanceAfter)
//       // })
...
//       //   expect(riskPoolBalanceAfter).to.equal(getBigNumber(8000))
...
//         // it("Should claim by claimAssessor", async function () {
//         //   const riskPool = this.RiskPool.attach(this.poolAddress)

//         //   const unoBalanceBefore = await this.mockUNO.balanceOf(this.signers[5].address)
//         //   expect(unoBalanceBefore).to.equal(0)

//         //   const unoBalanceOfPoolBefore = await this.mockUNO.balanceOf(riskPool.address)
//         //   expect(unoBalanceOfPoolBefore).to.equal(getBigNumber(20000))

//         //   await this.singleSidedReinsurancePool
//         //     .connect(this.signers[3])
//         //     .policyClaim(this.signers[5].address, getBigNumber(10000), { from: this.signers[3].address })

//         //   const unoBalanceAfter = await this.mockUNO.balanceOf(this.signers[5].address)
//         //   expect(unoBalanceAfter).to.equal(getBigNumber(10000))

//         //   const unoBalanceOfPoolAfter = await this.mockUNO.balanceOf(riskPool.address)
//         //   expect(unoBalanceOfPoolAfter).to.equal(getBigNumber(10000))
//         // })
...
//         // console.log("[pendingUnoRewardAfter1,2]", getNumber(pendingUnoRewardAfter1), getNumber(pendingUnoRewardAfter2))
//       })
//       it("Should transfer risk pool token", async function () {
//         const riskPool = this.RiskPool.attach(this.poolAddress);
...
//       it("Should check pending reward of the new address after transfer risk pool token", async function () {
//         const riskPool = this.RiskPool.attach(this.poolAddress);
//         const lpBalanceBeforeForSigner1 = await riskPool.balanceOf(this.signers[0].address);
//         const lpBalanceBeforeForSigner2 = await riskPool.balanceOf(this.signers[3].address);
//         expect(lpBalanceBeforeForSigner2).to.equal(0);
