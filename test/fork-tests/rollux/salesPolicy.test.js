...
describe("SalesPolicy", function () {
  ...
  describe("Sales policy Action", function () {
    ...
    it("Should buy policy in USDT directly", async function () {
      ...
      await this.salesPolicyFactory.setSignerInPolicy(this.signers[5].address)
    ...
    it("Should revert when invalid signer buy policy", async function () {
      ...
      await this.salesPolicyFactory.approvePremiumInPolicy(this.stakingAsset.target)
    ...
    it("Should revert when less premium paid in ETH", async function () {
      ...
      await this.premiumPool.addWhiteLis(this.salesPolicy.target)
    ...
    it("Should revert when protocol in blacklist", async function () {
      ...
      await this.salesPolicyFactory.updateCheckIfProtocolInWhitelistArray(true)

      await this.salesPolicyFactory.setBlackListProtocolByAddress(this.signers[1].address)
