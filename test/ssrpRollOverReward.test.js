...
describe("SingleSidedReinsurancePool", function () {
  ...
  beforeEach(async function () {
    ...
    await (await this.capitalAgent.addPoolWhiteList(this.SingleSidedReinsurancePool.address)).wait()
  ...
  describe("SingleSidedReinsurancePool RollOverReward Actions", function () {
    beforeEach(async function () {
      ...
      await this.mockUSDT.approve(this.SingleSidedReinsurancePool.address, getBigNumber("1000000"))
      await this.mockUSDT
      ...
      await this.mockUSDT
        ...
        .approve(this.SingleSidedReinsurancePool.address, getBigNumber("1000000"), { from: this.signers[2].address })
    ...
    describe("SingleSidedReinsurancePool RollOverReward", function () {
      it("should start the RollOverReward to self address after 10000 block", async function () {
        ...
        expect(beforeBlockNumber + 10000).to.eq(afterBlockNumber);
        ...
        await this.SingleSidedReinsurancePool.rollOverReward([this.signers[0].address, this.signers[1].address]);
