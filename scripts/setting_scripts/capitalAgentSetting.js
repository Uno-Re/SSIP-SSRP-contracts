...
async function main() {
  ...
  //   this.zeroAddress,
  // ])
  // console.log("[addPoolByAdmin]", encodedCallData)
  ...
  // encodedCallData = this.capitalAgent.interface.encodeFunctionData("setPolicyByAdmin", [this.salesPolicy.address])
  // console.log("[setPolicyByAdmin]", encodedCallData)
  ...
  // encodedCallData = this.capitalAgent.interface.encodeFunctionData("setOperator", [this.signers[0].address])
  // console.log("[setSalesPolicyFactory]", encodedCallData)
